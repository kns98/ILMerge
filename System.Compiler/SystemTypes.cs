...
namespace System.Compiler
{
  ...
  public sealed class SystemXmlAssemblyLocation{
        ...
        sealed class TargetPlatform
    {
      ...
      SystemXmlAssemblyLocation.Location = null;
        ...
        public static IDictionary StaticAssemblyCache => Reader.StaticAssemblyCache;
      ...
      new Version(1, 0, 5000);  // Default for an Everett compiler
        ...
        public static int LinkerMinorVersion => TargetVersion.Minor;

        public static int MajorVersion => TargetVersion.Major;
        public static int MinorVersion => TargetVersion.Minor;
        public static int Build => TargetVersion.Build;

        public static string /*!*/
            PlatformAssembliesLocation = string.Empty;

        private static TrivialHashtable assemblyReferenceFor;
        internal static bool AssemblyReferenceForInitialized => assemblyReferenceFor != null;

        public static TrivialHashtable /*!*/ AssemblyReferenceFor
        {
            get
            {
                if (assemblyReferenceFor == null) SetupAssemblyReferenceFor();
        ...
        private static readonly string[] /*!*/
            FxAssemblyNames =
            {
                "Accessibility", "CustomMarshalers", "IEExecRemote", "IEHost", "IIEHost", "ISymWrapper",
                ...
                "System.Security", "System.ServiceProcess", "System.Web", "System.Web.Mobile",
                "System.Web.RegularExpressions",
                "System.Web.Services", "System.Windows.Forms", "System.Xml", "TlbExpCode", "TlbImpCode", "cscompmgd",
                "vjswfchtml", "vjswfccw", "VJSWfcBrowserStubLib", "vjswfc", "vjslibcw", "vjslib", "vjscor",
                "VJSharpCodeProvider"
            };
        ...
        private static readonly string[] /*!*/
            FxAssemblyToken =
            {
                ...
                "b77a5c561934e089",
                "b03f5f7f11d50a3a", "b03f5f7f11d50a3a", "b03f5f7f11d50a3a", "b03f5f7f11d50a3a", "b03f5f7f11d50a3a",
                "b03f5f7f11d50a3a", "b77a5c561934e089", "b77a5c561934e089", "b03f5f7f11d50a3a", "b03f5f7f11d50a3a",
                "b03f5f7f11d50a3a",
                "b03f5f7f11d50a3a", "b03f5f7f11d50a3a", "b03f5f7f11d50a3a", "b03f5f7f11d50a3a", "b03f5f7f11d50a3a",
                "b03f5f7f11d50a3a", "b03f5f7f11d50a3a", "b03f5f7f11d50a3a"
            };
        ...
        private static readonly string[] /*!*/
            FxAssemblyVersion1 =
            {
                "1.0.3300.0", "1.0.3300.0", "1.0.3300.0", "1.0.3300.0", "1.0.3300.0", "1.0.3300.0",
                ...
                "1.0.3300.0", "1.0.3300.0", "1.0.3300.0", "1.0.3300.0", "1.0.3300.0", "1.0.3300.0", "1.0.3300.0",
                "7.0.3300.0"
            };

        private static readonly string[] /*!*/
            FxAssemblyVersion1_1 =
            {
                "1.0.5000.0", "1.0.5000.0", "1.0.5000.0", "1.0.5000.0", "1.0.5000.0", "1.0.5000.0",
                ...
                "1.0.5000.0", "1.0.5000.0", "1.0.5000.0", "1.0.5000.0", "1.0.5000.0", "1.0.5000.0", "1.0.5000.0",
                "7.0.5000.0"
            };

        private static readonly string[] /*!*/
            FxAssemblyVersion2Build3600 =
            {
                "2.0.3600.0", "2.0.3600.0", "2.0.3600.0", "2.0.3600.0", "2.0.3600.0", "2.0.3600.0",
                ...
                "2.0.3600.0", "2.0.3600.0", "2.0.3600.0", "2.0.3600.0", "2.0.3600.0", "2.0.3600.0", "2.0.3600.0",
                "7.0.5000.0"
            };
        ...
        public static void SetTo(Version /*!*/ version)
        {
            ...
            if (version.Major == 1)
            {
                if (version.Minor == 0 && version.Build == 3300) SetToV1();
                else if (version.Minor == 0 && version.Build == 5000) SetToV1_1();
                else if (version.Minor == 1 && version.Build == 9999) SetToPostV1_1(PlatformAssembliesLocation);
            }
            else if (version.Major == 2)
            {
                if (version.Minor == 0 && version.Build == 3600) SetToV2Beta1();
                else SetToV2();
            }
            else if (version.Major == 4)
            {
                if (version.Minor == 5) SetToV4_5();
                else SetToV4();
            }
            else
            {
        ...
        public static void SetTo(Version /*!*/ version, string /*!*/ platformAssembliesLocation)
        {
            ...
            if (version.Major == 1)
            {
                if (version.Minor == 0 && version.Build == 3300) SetToV1(platformAssembliesLocation);
                else if (version.Minor == 0 && version.Build == 5000) SetToV1_1(platformAssembliesLocation);
                else if (version.Minor == 1 && version.Build == 9999) SetToPostV1_1(platformAssembliesLocation);
            }
            else if (version.Major == 2)
            {
                if (version.Minor == 0 && version.Build == 3600) SetToV2Beta1(platformAssembliesLocation);
                else SetToV2(platformAssembliesLocation);
            }
            else if (version.Major == 4)
            {
                if (version.Minor == 5)
        ...
        {
            TargetVersion = new Version(1, 0, 3300);
            ...
            if (platformAssembliesLocation == null || platformAssembliesLocation.Length == 0)
                platformAssembliesLocation = PlatformAssembliesLocation =
                    Path.Combine(Path.GetDirectoryName(typeof(object).Assembly.Location), "..\\v1.0.3705");
            else
                PlatformAssembliesLocation = platformAssembliesLocation;
            InitializeStandardAssemblyLocationsWithDefaultValues(platformAssembliesLocation);
            var assemblyReferenceFor = new TrivialHashtable(46);
            for (int i = 0, n = FxAssemblyNames.Length; i < n; i++)
            {
                var name = FxAssemblyNames[i];
                var version = FxAssemblyVersion1[i];
                var token = FxAssemblyToken[i];
                var aref = new AssemblyReference(name + ", Version=" + version + ", Culture=neutral, PublicKeyToken=" +
                                                 token);
      ...
      SystemCompilerRuntimeAssemblyLocation.Location = SystemCompilerRuntimeAssemblyLocation.Location;
        ...
        {
            TargetVersion = new Version(1, 0, 5000);
            TargetRuntimeVersion = "v1.1.4322";
            if (platformAssembliesLocation == null || platformAssembliesLocation.Length == 0)
                platformAssembliesLocation = PlatformAssembliesLocation =
                    Path.Combine(Path.GetDirectoryName(typeof(object).Assembly.Location), "..\\v1.1.4322");
            else
                PlatformAssembliesLocation = platformAssembliesLocation;
            InitializeStandardAssemblyLocationsWithDefaultValues(platformAssembliesLocation);
            var assemblyReferenceFor = new TrivialHashtable(46);
            ...
            {
                var name = FxAssemblyNames[i];
                var version = FxAssemblyVersion1_1[i];
                var token = FxAssemblyToken[i];
                var aref = new AssemblyReference(name + ", Version=" + version + ", Culture=neutral, PublicKeyToken=" +
                                                 token);
                aref.Location = platformAssembliesLocation + "\\" + name + ".dll";
        ...
        {
            TargetVersion = new Version(2, 0, 50727);
            TargetRuntimeVersion = "v2.0.50727";
            GenericTypeNamesMangleChar = '`';
            if (platformAssembliesLocation == null || platformAssembliesLocation.Length == 0)
                platformAssembliesLocation = PlatformAssembliesLocation =
                    Path.Combine(Path.GetDirectoryName(typeof(object).Assembly.Location), "..\\v2.0.50727");
            else
                PlatformAssembliesLocation = platformAssembliesLocation;
            PlatformAssembliesLocation = platformAssembliesLocation;
            InitializeStandardAssemblyLocationsWithDefaultValues(platformAssembliesLocation);
            ...
            {
                var name = FxAssemblyNames[i];
                var version = FxAssemblyVersion2[i];
                var token = FxAssemblyToken[i];
                var aref = new AssemblyReference(name + ", Version=" + version + ", Culture=neutral, PublicKeyToken=" +
                                                 token);
                aref.Location = platformAssembliesLocation + "\\" + name + ".dll";
      ...
      SystemCompilerRuntimeAssemblyLocation.Location = SystemCompilerRuntimeAssemblyLocation.Location;
        ...
        {
            TargetVersion = new Version(2, 0, 3600);
            GenericTypeNamesMangleChar = '!';
            string dotNetDirLocation = null;
            if (platformAssembliesLocation == null || platformAssembliesLocation.Length == 0)
            {
                var dotNetDir = new FileInfo(new Uri(typeof(object).Assembly.Location).LocalPath).Directory.Parent;
                dotNetDirLocation = dotNetDir.FullName;
                if (dotNetDirLocation != null)
                    dotNetDirLocation = dotNetDirLocation.ToUpper(CultureInfo.InvariantCulture);
                var creationTime = DateTime.MinValue;
                foreach (var subdir in dotNetDir.GetDirectories("v2.0*"))
                {
                    if (subdir == null) continue;
                    if (subdir.CreationTime < creationTime) continue;
                    var mscorlibs = subdir.GetFiles("mscorlib.dll");
            ...
            if (dotNetDirLocation != null &&
                (platformAssembliesLocation == null || platformAssembliesLocation.Length == 0))
            {
                var pos = dotNetDirLocation.IndexOf("FRAMEWORK");
                if (pos > 0 && dotNetDirLocation.IndexOf("FRAMEWORK64") < 0)
                {
                    ...
                    {
                        var dotNetDir = new DirectoryInfo(dotNetDirLocation);
                        var creationTime = DateTime.MinValue;
                        foreach (var subdir in dotNetDir.GetDirectories("v2.0*"))
                        {
                            if (subdir == null) continue;
            ...
            {
                var name = FxAssemblyNames[i];
                var version = FxAssemblyVersion2Build3600[i];
                var token = FxAssemblyToken[i];
                var aref = new AssemblyReference(name + ", Version=" + version + ", Culture=neutral, PublicKeyToken=" +
                                                 token);
                aref.Location = platformAssembliesLocation + "\\" + name + ".dll";
      ...
      SystemCompilerRuntimeAssemblyLocation.Location = SystemCompilerRuntimeAssemblyLocation.Location;
        ...
        public static void SetToV4(string platformAssembliesLocation)
        {
            ...
            if (platformAssembliesLocation == null || platformAssembliesLocation.Length == 0)
                platformAssembliesLocation = PlatformAssembliesLocation =
                    Path.Combine(Path.GetDirectoryName(typeof(object).Assembly.Location), "..\\v4.0.30319");
            else
                PlatformAssembliesLocation = platformAssembliesLocation;
            PlatformAssembliesLocation = platformAssembliesLocation;
            InitializeStandardAssemblyLocationsWithDefaultValues(platformAssembliesLocation);
            ...
            {
                var name = FxAssemblyNames[i];
                var version = FxAssemblyVersion4[i];
                var token = FxAssemblyToken[i];
                var aref = new AssemblyReference(name + ", Version=" + version + ", Culture=neutral, PublicKeyToken=" +
                                                 token);
                aref.Location = platformAssembliesLocation + "\\" + name + ".dll";
      ...
      SystemCompilerRuntimeAssemblyLocation.Location = SystemCompilerRuntimeAssemblyLocation.Location;
        ...
        {
            PlatformAssembliesLocation = platformAssembliesLocation;
            TargetVersion = new Version(2, 1, 9999);
            TargetRuntimeVersion = "v2.1.9999";
            InitializeStandardAssemblyLocationsWithDefaultValues(platformAssembliesLocation);
            assemblyReferenceFor = new TrivialHashtable(46);
            var dlls = Directory.GetFiles(platformAssembliesLocation, "*.dll");
            foreach (var dll in dlls)
            {
                if (dll == null) continue;
                var assemName = Path.GetFileNameWithoutExtension(dll);
                var i = Array.IndexOf(FxAssemblyNames, assemName);
                if (i < 0) continue;
#if CodeContracts
                var loc = Path.Combine(platformAssembliesLocation, dll);
                var aref = new AssemblyReference(assemName);
                aref.Location = loc;
                assemblyReferenceFor[Identifier.For(assemName).UniqueIdKey] = aref;
#else
      ...
      SystemCompilerRuntimeAssemblyLocation.Location = SystemCompilerRuntimeAssemblyLocation.Location;
        ...
        {
            PlatformAssembliesLocation = platformAssembliesLocation;
            TargetVersion = new Version(1, 1, 9999);
            ...
            foreach (var dll in dlls)
            {
                ...
                var i = Array.IndexOf(FxAssemblyNames, assemName);
                if (i < 0) continue;
                var assem = AssemblyNode.GetAssembly(Path.Combine(platformAssembliesLocation, dll));
                if (assem == null) continue;
                assemblyReferenceFor[Identifier.For(assem.Name).UniqueIdKey] = new AssemblyReference(assem);
            }
#if ExtendedRuntime
      SystemCompilerRuntimeAssemblyLocation.Location = SystemCompilerRuntimeAssemblyLocation.Location;
#endif
        ...
        private static void InitializeStandardAssemblyLocationsWithDefaultValues(string platformAssembliesLocation,
            string mscorlibName, string alternateName)
        {
      ...
      if (SystemXmlAssemblyLocation.Location == null)
        ...
        public static void ResetCci(string platformAssembliesLocation, Version targetVersion, bool doNotLockFile,
            bool getDebugInfo, AssemblyNode.PostAssemblyLoadProcessor postAssemblyLoad = null)
        {
            Clear();
    ...
    public static Method NonNullTypeAssertInitialized {
      get {
        if (nonNullTypeAssertInitialized == null) {
          if (NonNullType != null) {
            nonNullTypeAssertInitialized =
 NonNullType.GetMethod(Identifier.For("AssertInitialized"), SystemTypes.Object);
          }
        }
    ...
    public static void Initialize(bool doNotLockFile, bool getDebugInfo) {
      SystemCompilerRuntimeAssembly =
 ExtendedRuntimeTypes.GetSystemCompilerRuntimeAssembly(doNotLockFile, getDebugInfo);
...
#endif
      ConstrainedType =
 (Interface)GetCompilerRuntimeTypeNodeFor("StructuralTypes", "IConstrainedType", ElementType.Class);
      ...
      NotNullArrayElementsAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(ContractsNs, "NotNullArrayElementsAttribute", ElementType.Class);
      NotNullGenericArgumentsAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(ContractsNs, "NotNullGenericArgumentsAttribute", ElementType.Class);
      ...
      EncodedTypeSpecAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(ContractsNs, "EncodedTypeSpecAttribute", ElementType.Class);
      StrictReadonlyAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(ContractsNs, "StrictReadonlyAttribute", ElementType.Class);
      ...
      TypeDefinition =
 (Interface)GetCompilerRuntimeTypeNodeFor("StructuralTypes", "ITypeDefinition", ElementType.Class);
      TypeIntersection =
 (Interface)GetCompilerRuntimeTypeNodeFor("StructuralTypes", "ITypeIntersection", ElementType.Class);
    ...
    private static AssemblyNode/*!*/ GetSystemCompilerRuntimeAssembly(bool doNotLockFile, bool getDebugInfo)
    {
      ...
      if (result == null) {
        result =
 (AssemblyNode)(new Reader(SystemCompilerRuntimeAssemblyLocation.Location, SystemAssemblyLocation.SystemAssemblyCache, doNotLockFile, getDebugInfo, true, false)).ReadModule();
      }
      if (result == null) {
        SystemCompilerRuntimeAssemblyLocation.Location = typeof(ComposerAttribute).Assembly.Location;
        result =
 ...
 CoreSystemTypes.GetDummyTypeNode(SystemCompilerRuntimeAssembly, nspace, name, typeCode);
        ...
        sealed class CoreSystemTypes
    {
        ...
        public static void Clear()
        {
            lock (Module.GlobalLock)
            {
                ...
                {
                    foreach (AssemblyNode cachedAssembly in new ArrayList(Reader.StaticAssemblyCache.Values))
        ...
        public static void Initialize(bool doNotLockFile, bool getDebugInfo,
            AssemblyNode.PostAssemblyLoadProcessor postAssemblyLoad = null)
        {
            ...
            if (SystemAssembly == null)
                SystemAssembly = GetSystemAssembly(doNotLockFile, getDebugInfo, postAssemblyLoad);
            ...
            DynamicallyTypedReference =
                (Struct)GetTypeNodeFor("System", "TypedReference", ElementType.DynamicallyTypedReference);
#if !MinimalReader
            ...
            DBNull = (Class)GetTypeNodeFor("System", "DBNull",
                ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
...
#endif
            ArgIterator =
                (Struct)GetTypeNodeFor("System", "ArgIterator",
                    ElementType
                        .ValueType); //Where does this mscorlib type live in the new world of reference assemblies?
...
#if !MinimalReader
            RuntimeArgumentHandle =
                (Struct)GetTypeNodeFor("System", "RuntimeArgumentHandle",
                    ElementType
                        .ValueType); //Where does this mscorlib type live in the new world of reference assemblies?
#endif
            SecurityAction =
                GetTypeNodeFor("System.Security.Permissions", "SecurityAction",
                        ElementType.ValueType) as
                    EnumNode; //Where does this mscorlib type live in the new world of reference assemblies?
            Initialized = true;
        ...
        {
            if (TargetPlatform.TargetVersion != null && TargetPlatform.TargetVersion.Major < 2 &&
                TargetPlatform.TargetVersion.Minor < 2) return;
        ...
        private static void InstantiateGenericInterfaces(TypeNode type)
        {
            ...
            {
                var ifaceExpr = interfaces[i] as InterfaceExpression;
                if (ifaceExpr == null) continue;
                if (ifaceExpr.Template == null)
                {
                    Debug.Assert(false);
                    continue;
                }

                var templArgs = ifaceExpr.TemplateArguments;
                for (int j = 0, m = templArgs.Count; j < m; j++)
                {
                    var ie = templArgs[j] as InterfaceExpression;
                    if (ie != null)
                        templArgs[j] = ie.Template.GetGenericTemplateInstance(type.DeclaringModule,
                            ie.ConsolidatedTemplateArguments);
                }

                interfaces[i] = (Interface)ifaceExpr.Template.GetGenericTemplateInstance(type.DeclaringModule,
                    ifaceExpr.ConsolidatedTemplateArguments);
            }
        }

        private static AssemblyNode /*!*/ GetSystemAssembly(bool doNotLockFile, bool getDebugInfo,
            AssemblyNode.PostAssemblyLoadProcessor postAssemblyLoad)
        {
            var result = SystemAssemblyLocation.ParsedAssembly;
            if (result != null)
            {
            ...
            result = (AssemblyNode)new Reader(SystemAssemblyLocation.Location,
                    SystemAssemblyLocation.SystemAssemblyCache, doNotLockFile, getDebugInfo, true, false)
                .ReadModule(postAssemblyLoad);
            if (result == null && TargetPlatform.TargetVersion != null &&
                TargetPlatform.TargetVersion == typeof(object).Assembly.GetName().Version)
            {
                SystemAssemblyLocation.Location = typeof(object).Assembly.Location;
                result = (AssemblyNode)new Reader(SystemAssemblyLocation.Location,
            ...
            {
                result = new AssemblyNode();
                var aname = typeof(object).Assembly.GetName();
                result.Name = aname.Name;
        ...
        private static TypeNode /*!*/ GetTypeNodeFor(string /*!*/ nspace, string /*!*/ name, ElementType typeCode)
        {
            ...
            if (result == null) result = GetDummyTypeNode(SystemAssembly, nspace, name, typeCode);
            result.typeCode = typeCode;
            return result;
        }

        internal static TypeNode /*!*/ GetDummyTypeNode(AssemblyNode declaringAssembly, string /*!*/ nspace,
            string /*!*/ name, ElementType typeCode)
        {
            TypeNode result = null;
            switch (typeCode)
            {
                ...
                case ElementType.Class:
                    if (name.Length > 1 && name[0] == 'I' && char.IsUpper(name[1]))
                        ...
                        result = new Class();
                    else if (name.EndsWith("Callback") || name.EndsWith("Handler") || name.EndsWith("Delegate") ||
                             name == "ThreadStart" || name == "FrameGuardGetter" || name == "GuardThreadStart")
    ...
    public static AssemblyNode /*!*/SystemXmlAssembly;
        ...
        public static AssemblyNode /*!*/
            DiagnosticsDebugAssembly;

        public static AssemblyNode /*!*/
            DiagnosticsToolsAssembly;
        ...
        public static AssemblyNode /*!*/
            SystemRuntimeExtensionsAssembly;

        public static AssemblyNode /*!*/
            SystemRuntimeSerializationAssembly;
        ...
        public static AssemblyNode /*!*/ SystemRuntimeWindowsRuntimeAssembly
        {
            get
            {
                if (systemRuntimeWindowsRuntimeAssembly == null)
                    systemRuntimeWindowsRuntimeAssembly =
                        GetSystemRuntimeWindowsRuntimeAssembly(CoreSystemTypes.doNotLockFile,
                            CoreSystemTypes.getDebugInfo);
                return systemRuntimeWindowsRuntimeAssembly;
            }
        }

        public static AssemblyNode /*!*/
            SystemRuntimeWindowsRuntimeInteropAssembly;

        private static AssemblyNode /*!*/
            systemRuntimeWindowsRuntimeUIXamlAssembly;
        ...
        public static AssemblyNode /*!*/ SystemRuntimeWindowsRuntimeUIXamlAssembly
        {
            get
            {
                if (systemRuntimeWindowsRuntimeUIXamlAssembly == null)
                    systemRuntimeWindowsRuntimeUIXamlAssembly =
                        GetSystemRuntimeWindowsRuntimeUIXamlAssembly(CoreSystemTypes.doNotLockFile,
                            CoreSystemTypes.getDebugInfo);
        ...
        private static Delayed<Struct> /*!*/
            color;

        public static Struct Color => color;
        private static Delayed<Struct> cornerRadius;
        public static Struct /*!*/ CornerRadius => cornerRadius;
        ...
        private static Delayed<Struct> duration;
        public static Struct /*!*/ Duration => duration;
        private static Delayed<EnumNode> durationType;
        public static EnumNode /*?*/ DurationType => durationType;
        ...
        private static Delayed<Struct> generatorPosition;
        public static Struct /*!*/ GeneratorPosition => generatorPosition;
        public static Struct /*!*/
            GenericArraySegment;
#if !WHIDBEYwithGenerics
        public static Class /*!*/
            GenericArrayToIEnumerableAdapter;
#endif
        public static Class /*!*/
            GenericDictionary;
        ...
        private static Delayed<Struct> gridLength;
        public static Struct /*!*/ GridLength => gridLength;
        private static Delayed<EnumNode> gridUnitType;
        public static EnumNode /*?*/ GridUnitType => gridUnitType;
        ...
        private static Delayed<Struct> keyTime;
        public static Struct /*!*/ KeyTime => keyTime;
        ...
        private static Delayed<Struct> matrix;
        public static Struct /*!*/ Matrix => matrix;
        private static Delayed<Struct> matrix3D;
        public static Struct /*!*/ Matrix3D => matrix3D;
        ...
        public static Struct /*!*/ Point => point;
        ...
        public static Struct /*!*/ Rect => rect;
        private static Delayed<Struct> repeatBehavior;
        public static Struct /*!*/ RepeatBehavior => repeatBehavior;
        private static Delayed<EnumNode> repeatBehaviorType;
        public static EnumNode /*?*/ RepeatBehaviorType => repeatBehaviorType;
        ...
        private static Delayed<Struct> size;
        public static Struct /*!*/ Size => size;
        ...
        public static Struct /*!*/ Thickness => thickness;
    ...
    internal static void RaiseClearingSystemTypes()
    {
      ...
      SystemXmlAssembly = SystemTypes.GetSystemXmlAssembly(doNotLockFile, getDebugInfo);
            ...
            ConditionalAttribute =
                (Class)GetTypeNodeFor("System.Diagnostics", "ConditionalAttribute", ElementType.Class);
            DefaultMemberAttribute =
                (Class)GetTypeNodeFor("System.Reflection", "DefaultMemberAttribute", ElementType.Class);
            InternalsVisibleToAttribute = (Class)GetTypeNodeFor("System.Runtime.CompilerServices",
                "InternalsVisibleToAttribute", ElementType.Class);
            ObsoleteAttribute = (Class)GetTypeNodeFor("System", "ObsoleteAttribute", ElementType.Class);

            GenericICollection =
                (Interface)GetGenericRuntimeTypeNodeFor("System.Collections.Generic", "ICollection", 1,
                    ElementType.Class);
            GenericIEnumerable =
                (Interface)GetGenericRuntimeTypeNodeFor("System.Collections.Generic", "IEnumerable", 1,
                    ElementType.Class);
            GenericIList =
                (Interface)GetGenericRuntimeTypeNodeFor("System.Collections.Generic", "IList", 1, ElementType.Class);
            ICloneable =
                (Interface)GetTypeNodeFor("System", "ICloneable",
                    ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
...
#if !MinimalReader
            AllowPartiallyTrustedCallersAttribute = (Class)GetTypeNodeFor("System.Security",
                "AllowPartiallyTrustedCallersAttribute",
                ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
            AssemblyCompanyAttribute =
                (Class)GetTypeNodeFor("System.Reflection", "AssemblyCompanyAttribute", ElementType.Class);
            AssemblyConfigurationAttribute = (Class)GetTypeNodeFor("System.Reflection",
                "AssemblyConfigurationAttribute", ElementType.Class);
            AssemblyCopyrightAttribute =
                (Class)GetTypeNodeFor("System.Reflection", "AssemblyCopyrightAttribute", ElementType.Class);
            AssemblyCultureAttribute =
                (Class)GetTypeNodeFor("System.Reflection", "AssemblyCultureAttribute", ElementType.Class);
            AssemblyDelaySignAttribute =
                (Class)GetTypeNodeFor("System.Reflection", "AssemblyDelaySignAttribute", ElementType.Class);
            AssemblyDescriptionAttribute =
                (Class)GetTypeNodeFor("System.Reflection", "AssemblyDescriptionAttribute", ElementType.Class);
            AssemblyFileVersionAttribute =
                (Class)GetTypeNodeFor("System.Reflection", "AssemblyFileVersionAttribute", ElementType.Class);
            AssemblyFlagsAttribute =
                (Class)GetTypeNodeFor("System.Reflection", "AssemblyFlagsAttribute", ElementType.Class);
            AssemblyInformationalVersionAttribute = (Class)GetTypeNodeFor("System.Reflection",
                "AssemblyInformationalVersionAttribute", ElementType.Class);
            AssemblyKeyFileAttribute =
                (Class)GetTypeNodeFor("System.Reflection", "AssemblyKeyFileAttribute", ElementType.Class);
            AssemblyKeyNameAttribute =
                (Class)GetTypeNodeFor("System.Reflection", "AssemblyKeyNameAttribute", ElementType.Class);
            AssemblyProductAttribute =
                (Class)GetTypeNodeFor("System.Reflection", "AssemblyProductAttribute", ElementType.Class);
            AssemblyTitleAttribute =
                (Class)GetTypeNodeFor("System.Reflection", "AssemblyTitleAttribute", ElementType.Class);
            AssemblyTrademarkAttribute =
                (Class)GetTypeNodeFor("System.Reflection", "AssemblyTrademarkAttribute", ElementType.Class);
            AssemblyVersionAttribute =
                (Class)GetTypeNodeFor("System.Reflection", "AssemblyVersionAttribute", ElementType.Class);
            AttributeTargets = GetTypeNodeFor("System", "AttributeTargets", ElementType.ValueType) as EnumNode;
            color = new Func<TypeNode>(() =>
                GetWindowsRuntimeTypeNodeFor("Windows.UI", "Color",
                    ElementType.ValueType)); //projected from Windows.UI.Xaml.Media, but to where?
            cornerRadius = new Func<TypeNode>(() =>
                GetWindowsRuntimeUIXamlTypeNodeFor("Windows.UI.Xaml", "CornerRadius",
                    ElementType.ValueType)); //projected from Windows.UI.Xaml but to where?
            ClassInterfaceAttribute = (Class)GetInteropTypeNodeFor("System.Runtime.InteropServices",
                "ClassInterfaceAttribute", ElementType.Class);
            CLSCompliantAttribute = (Class)GetTypeNodeFor("System", "CLSCompliantAttribute", ElementType.Class);
            ComImportAttribute = (Class)GetInteropTypeNodeFor("System.Runtime.InteropServices", "ComImportAttribute",
                ElementType.Class);
            ComRegisterFunctionAttribute = (Class)GetInteropTypeNodeFor("System.Runtime.InteropServices",
                "ComRegisterFunctionAttribute", ElementType.Class);
            ComSourceInterfacesAttribute = (Class)GetInteropTypeNodeFor("System.Runtime.InteropServices",
                "ComSourceInterfacesAttribute", ElementType.Class);
            ComUnregisterFunctionAttribute = (Class)GetInteropTypeNodeFor("System.Runtime.InteropServices",
                "ComUnregisterFunctionAttribute", ElementType.Class);
            ComVisibleAttribute = (Class)GetTypeNodeFor("System.Runtime.InteropServices", "ComVisibleAttribute",
                ElementType.Class);
            DebuggableAttribute = (Class)GetTypeNodeFor("System.Diagnostics", "DebuggableAttribute", ElementType.Class);
            DebuggerHiddenAttribute =
                (Class)GetDiagnosticsDebugTypeNodeFor("System.Diagnostics", "DebuggerHiddenAttribute",
                    ElementType.Class);
            DebuggerStepThroughAttribute = (Class)GetDiagnosticsDebugTypeNodeFor("System.Diagnostics",
                "DebuggerStepThroughAttribute", ElementType.Class);
            DebuggingModes = DebuggableAttribute == null
                ? null
                : DebuggableAttribute.GetNestedType(Identifier.For("DebuggingModes")) as EnumNode;
            DllImportAttribute = (Class)GetInteropTypeNodeFor("System.Runtime.InteropServices", "DllImportAttribute",
                ElementType.Class);
            duration = new Func<TypeNode>(() =>
                GetWindowsRuntimeUIXamlTypeNodeFor("Windows.UI.Xaml", "Duration",
                    ElementType.ValueType)); //projected from Windows.UI.Xaml but to where?
            durationType = new Func<TypeNode>(() =>
                GetWindowsRuntimeUIXamlTypeNodeFor("Windows.UI.Xaml", "DurationType",
                    ElementType.ValueType) as EnumNode); //projected from Windows.UI.Xaml but to where?
            FieldOffsetAttribute = (Class)GetTypeNodeFor("System.Runtime.InteropServices", "FieldOffsetAttribute",
                ElementType.Class);
            FlagsAttribute = (Class)GetTypeNodeFor("System", "FlagsAttribute", ElementType.Class);
            generatorPosition = new Func<TypeNode>(() =>
                GetWindowsRuntimeUIXamlTypeNodeFor("Windows.UI.Xaml.Controls.Primitives", "GeneratorPosition",
                    ElementType.ValueType)); //projected from Windows.UI.Xaml.Controls.Primitives but to where?
            Guid = (Struct)GetTypeNodeFor("System", "Guid", ElementType.ValueType);
            GuidAttribute =
                (Class)GetInteropTypeNodeFor("System.Runtime.InteropServices", "GuidAttribute", ElementType.Class);
            gridLength = new Func<TypeNode>(() =>
                GetWindowsRuntimeUIXamlTypeNodeFor("Windows.UI.Xaml", "GridLength",
                    ElementType.ValueType)); //projected from Windows.UI.Xaml but to where?
            gridUnitType = new Func<TypeNode>(() =>
                GetWindowsRuntimeUIXamlTypeNodeFor("Windows.UI.Xaml", "GridUnitType",
                    ElementType.ValueType) as EnumNode); //projected from Windows.UI.Xaml but to where?
            ImportedFromTypeLibAttribute = (Class)GetInteropTypeNodeFor("System.Runtime.InteropServices",
                "ImportedFromTypeLibAttribute", ElementType.Class);
            InAttribute =
                (Class)GetInteropTypeNodeFor("System.Runtime.InteropServices", "InAttribute", ElementType.Class);
            IndexerNameAttribute = (Class)GetTypeNodeFor("System.Runtime.CompilerServices", "IndexerNameAttribute",
                ElementType.Class);
            InterfaceTypeAttribute = (Class)GetInteropTypeNodeFor("System.Runtime.InteropServices",
                "InterfaceTypeAttribute", ElementType.Class);
            keyTime = new Func<TypeNode>(() =>
                GetWindowsRuntimeUIXamlTypeNodeFor("Windows.UI.Xaml.Media.Animation", "KeyTime",
                    ElementType.ValueType)); //projected from Windows.UI.Xaml.Media.Animation but to where?
            repeatBehavior = new Func<TypeNode>(() =>
                GetWindowsRuntimeUIXamlTypeNodeFor("Windows.UI.Xaml.Media.Animation", "RepeatBehavior",
                    ElementType.ValueType)); //projected from Windows.UI.Xaml.Media.Animation but to where?
            repeatBehaviorType = new Func<TypeNode>(() =>
                GetWindowsRuntimeUIXamlTypeNodeFor("Windows.UI.Xaml.Media.Animation", "RepeatBehaviorType",
                    ElementType.ValueType) as EnumNode); //projected from ?? to ??
            MethodImplAttribute = (Class)GetTypeNodeFor("System.Runtime.CompilerServices", "MethodImplAttribute",
                ElementType.Class);
            matrix = new Func<TypeNode>(() =>
                GetWindowsRuntimeUIXamlTypeNodeFor("Windows.UI.Xaml.Media", "Matrix",
                    ElementType.ValueType)); //projected from Windows.UI.Xaml.Media but to where?
            matrix3D = new Func<TypeNode>(() =>
                GetWindowsRuntimeUIXamlTypeNodeFor("Windows.UI.Xaml.Media.Media3D", "Matrix3D",
                    ElementType.ValueType)); //projected from Windows.UI.Xaml.Media.Media3D but to where?
            NonSerializedAttribute =
                (Class)GetTypeNodeFor("System", "NonSerializedAttribute",
                    ElementType
                        .Class); //Where does this mscorlib type live in the new world of reference assemblies?     
            OptionalAttribute = (Class)GetInteropTypeNodeFor("System.Runtime.InteropServices", "OptionalAttribute",
                ElementType.Class);
            ...
            point = new Func<TypeNode>(() =>
                GetWindowsRuntimeTypeNodeFor("Windows.Foundation", "Point", ElementType.ValueType));
            rect = new Func<TypeNode>(() =>
                GetWindowsRuntimeTypeNodeFor("Windows.Foundation", "Rect", ElementType.ValueType));
            RuntimeCompatibilityAttribute = (Class)GetTypeNodeFor("System.Runtime.CompilerServices",
                "RuntimeCompatibilityAttribute", ElementType.Class);
            SatelliteContractVersionAttribute = (Class)GetResourceManagerTypeNodeFor("System.Resources",
                "SatelliteContractVersionAttribute", ElementType.Class);
            SerializableAttribute =
                (Class)GetTypeNodeFor("System", "SerializableAttribute",
                    ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
            SecurityAttribute =
                (Class)GetTypeNodeFor("System.Security.Permissions", "SecurityAttribute",
                    ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
            SecurityCriticalAttribute =
                (Class)GetTypeNodeFor("System.Security", "SecurityCriticalAttribute", ElementType.Class);
            SecurityTransparentAttribute =
                (Class)GetTypeNodeFor("System.Security", "SecurityTransparentAttribute", ElementType.Class);
            SecurityTreatAsSafeAttribute =
                (Class)GetTypeNodeFor("System.Security", "SecurityTreatAsSafeAttribute",
                    ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
            size = new Func<TypeNode>(() =>
                GetWindowsRuntimeTypeNodeFor("Windows.Foundation", "Size", ElementType.ValueType));
            STAThreadAttribute = (Class)GetTypeNodeFor("System", "STAThreadAttribute", ElementType.Class);
            StructLayoutAttribute = (Class)GetTypeNodeFor("System.Runtime.InteropServices", "StructLayoutAttribute",
                ElementType.Class);
            SuppressMessageAttribute = (Class)GetDiagnosticsToolsTypeNodeFor("System.Diagnostics.CodeAnalysis",
                "SuppressMessageAttribute", ElementType.Class);
            SuppressUnmanagedCodeSecurityAttribute = (Class)GetTypeNodeFor("System.Security",
                "SuppressUnmanagedCodeSecurityAttribute",
                ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
            SecurityAction =
                GetTypeNodeFor("System.Security.Permissions", "SecurityAction",
            ...
            AppDomain = (Class)GetTypeNodeFor("System", "AppDomain",
                ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
            ApplicationException =
                (Class)GetTypeNodeFor("System", "ApplicationException",
                    ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
            ...
            ArgumentOutOfRangeException =
                (Class)GetTypeNodeFor("System", "ArgumentOutOfRangeException", ElementType.Class);
            ArrayList = (Class)GetTypeNodeFor("System.Collections", "ArrayList",
                ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
            ...
            CodeAccessPermission =
                (Class)GetTypeNodeFor("System.Security", "CodeAccessPermission",
                    ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
            CollectionBase =
                (Class)GetTypeNodeFor("System.Collections", "CollectionBase",
                    ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
            CultureInfo = (Class)GetGlobalizationTypeNodeFor("System.Globalization", "CultureInfo", ElementType.Class);
            DictionaryBase =
                (Class)GetTypeNodeFor("System.Collections", "DictionaryBase",
                    ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
            DictionaryEntry =
                (Struct)GetTypeNodeFor("System.Collections", "DictionaryEntry",
                    ElementType
                        .ValueType); //Where does this mscorlib type live in the new world of reference assemblies?
            DuplicateWaitObjectException =
                (Class)GetTypeNodeFor("System", "DuplicateWaitObjectException",
                    ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
            ...
            EventHandler1 =
                GetGenericRuntimeTypeNodeFor("System", "EventHandler", 1, ElementType.Class) as DelegateNode;
            EventRegistrationToken = (Struct)GetWindowsRuntimeInteropTypeNodeFor(
                "System.Runtime.InteropServices.WindowsRuntime", "EventRegistrationToken", ElementType.ValueType);
            ExecutionEngineException =
                (Class)GetTypeNodeFor("System", "ExecutionEngineException",
                    ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
            GenericArraySegment =
                (Struct)GetGenericRuntimeTypeNodeFor("System", "ArraySegment", 1, ElementType.ValueType);
            GenericDictionary = (Class)GetCollectionsGenericRuntimeTypeNodeFor("System.Collections.Generic",
                "Dictionary", 2, ElementType.Class);
            GenericIComparable = (Interface)GetCollectionsGenericRuntimeTypeNodeFor("System.Collections.Generic",
                "IComparable", 1, ElementType.Class);
            GenericIComparer =
                (Interface)GetGenericRuntimeTypeNodeFor("System.Collections.Generic", "IComparer", 1,
                    ElementType.Class);
            GenericIDictionary =
                (Interface)GetGenericRuntimeTypeNodeFor("System.Collections.Generic", "IDictionary", 2,
                    ElementType.Class);
            GenericIEnumerator =
                (Interface)GetGenericRuntimeTypeNodeFor("System.Collections.Generic", "IEnumerator", 1,
                    ElementType.Class);
            GenericIReadOnlyDictionary = (Interface)GetGenericRuntimeTypeNodeFor("System.Collections.Generic",
                "IReadOnlyDictionary", 2, ElementType.Class);
            GenericIReadOnlyList = (Interface)GetGenericRuntimeTypeNodeFor("System.Collections.Generic",
                "IReadOnlyList", 1, ElementType.Class);
            GenericKeyValuePair = (Struct)GetGenericRuntimeTypeNodeFor("System.Collections.Generic", "KeyValuePair", 2,
                ElementType.ValueType);
            GenericList =
                (Class)GetCollectionsGenericRuntimeTypeNodeFor("System.Collections.Generic", "List", 1,
                    ElementType.Class);
            GenericNullable = (Struct)GetGenericRuntimeTypeNodeFor("System", "Nullable", 1, ElementType.ValueType);
            GenericQueue =
                (Class)GetCollectionsGenericRuntimeTypeNodeFor("System.Collections.Generic", "Queue", 1,
                    ElementType.Class);
            GenericSortedDictionary = (Class)GetCollectionsGenericRuntimeTypeNodeFor("System.Collections.Generic",
                "SortedDictionary", 2, ElementType.Class);
            GenericStack =
                (Class)GetCollectionsGenericRuntimeTypeNodeFor("System.Collections.Generic", "Stack", 1,
                    ElementType.Class);
            GC = (Class)GetRuntimeExtensionsTypeNodeFor("System", "GC", ElementType.Class);
            __HandleProtector =
                (Class)GetTypeNodeFor("System.Threading", "__HandleProtector",
                    ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
            HandleRef = (Struct)GetInteropTypeNodeFor("System.Runtime.InteropServices", "HandleRef",
                ElementType.ValueType);
            Hashtable = (Class)GetTypeNodeFor("System.Collections", "Hashtable",
                ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
            IASyncResult = (Interface)GetTypeNodeFor("System", "IAsyncResult", ElementType.Class);
            ICommand = (Interface)GetTypeNodeFor("System.Windows.Input", "ICommand",
                ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
            ...
            IDictionary =
                (Interface)GetTypeNodeFor("System.Collections", "IDictionary",
                    ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
            ...
            IHashCodeProvider =
                (Interface)GetTypeNodeFor("System.Collections", "IHashCodeProvider",
                    ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
            IMembershipCondition =
                (Interface)GetTypeNodeFor("System.Security.Policy", "IMembershipCondition",
                    ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
            ...
            INotifyCollectionChanged = (Interface)GetSystemTypeNodeFor("System.Collections.Specialized",
                "INotifyCollectionChanged", ElementType.Class);
            INotifyPropertyChanged =
                (Interface)GetSystemTypeNodeFor("System.ComponentModel", "INotifyPropertyChanged", ElementType.Class);
            ...
            IPermission =
                (Interface)GetTypeNodeFor("System.Security", "IPermission",
                    ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
            ISerializable =
                (Interface)GetTypeNodeFor("System.Runtime.Serialization", "ISerializable",
                    ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
            IStackWalk =
                (Interface)GetTypeNodeFor("System.Security", "IStackWalk",
                    ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
            Marshal = (Class)GetInteropTypeNodeFor("System.Runtime.InteropServices", "Marshal", ElementType.Class);
            MarshalByRefObject =
                (Class)GetTypeNodeFor("System", "MarshalByRefObject",
                    ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
            ...
            NativeOverlapped =
                (Struct)GetThreadingTypeNodeFor("System.Threading", "NativeOverlapped", ElementType.ValueType);
            NotifyCollectionChangedAction = GetSystemTypeNodeFor("System.Collections.Specialized",
                "NotifyCollectionChangedAction", ElementType.ValueType) as EnumNode;
            NotifyCollectionChangedEventArgs = (Class)GetSystemTypeNodeFor("System.Collections.Specialized",
                "NotifyCollectionChangedEventArgs", ElementType.Class);
            NotifyCollectionChangedEventHandler = (DelegateNode)GetSystemTypeNodeFor("System.Collections.Specialized",
                "NotifyCollectionChangedEventHandler", ElementType.Class);
            ...
            PropertyChangedEventArgs =
                (Class)GetSystemTypeNodeFor("System.ComponentModel", "PropertyChangedEventArgs", ElementType.Class);
            PropertyChangedEventHandler = (DelegateNode)GetSystemTypeNodeFor("System.ComponentModel",
                "PropertyChangedEventHandler", ElementType.Class);
            Queue = (Class)GetCollectionsTypeNodeFor("System.Collections", "Queue", ElementType.Class);
            ReadOnlyCollectionBase =
                (Class)GetTypeNodeFor("System.Collections", "ReadOnlyCollectionBase",
                    ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
            ResourceManager =
                (Class)GetResourceManagerTypeNodeFor("System.Resources", "ResourceManager", ElementType.Class);
            ResourceSet =
                (Class)GetTypeNodeFor("System.Resources", "ResourceSet",
                    ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
            SerializationInfo =
                (Class)GetTypeNodeFor("System.Runtime.Serialization", "SerializationInfo",
                    ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
            Stack = (Class)GetTypeNodeFor("System.Collections", "Stack",
                ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
            StackOverflowException =
                (Class)GetTypeNodeFor("System", "StackOverflowException",
                    ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
            Stream = (Class)GetIOTypeNodeFor("System.IO", "Stream", ElementType.Class);
            StreamingContext = (Struct)GetRuntimeSerializationTypeNodeFor("System.Runtime.Serialization",
                "StreamingContext", ElementType.ValueType);
            ...
            SystemException =
                (Class)GetTypeNodeFor("System", "SystemException",
                    ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
            Thread = (Class)GetThreadingTypeNodeFor("System.Threading", "Thread", ElementType.Class);
            thickness = new Func<TypeNode>(() =>
                GetWindowsRuntimeUIXamlTypeNodeFor("Windows.UI.Xaml", "Thickness",
                    ElementType.ValueType)); //projected from Windows.UI.Xaml but to where?
            Uri = (Class)GetSystemTypeNodeFor("System", "Uri", ElementType.Class);
            WindowsImpersonationContext = (Class)GetTypeNodeFor("System.Security.Principal",
                "WindowsImpersonationContext",
                ElementType.Class); //Where does this mscorlib type live in the new world of reference assemblies?
#endif
#if ExtendedRuntime
#if !NoXml && !NoRuntimeXml
      XmlAttributeAttributeClass =
 (Class)GetXmlTypeNodeFor("System.Xml.Serialization", "XmlAttributeAttribute", ElementType.Class);
      XmlChoiceIdentifierAttributeClass =
 (Class)GetXmlTypeNodeFor("System.Xml.Serialization", "XmlChoiceIdentifierAttribute", ElementType.Class);
      XmlElementAttributeClass =
 (Class)GetXmlTypeNodeFor("System.Xml.Serialization", "XmlElementAttribute", ElementType.Class);
      XmlIgnoreAttributeClass =
 (Class)GetXmlTypeNodeFor("System.Xml.Serialization", "XmlIgnoreAttribute", ElementType.Class);
      XmlTypeAttributeClass =
 (Class)GetXmlTypeNodeFor("System.Xml.Serialization", "XmlTypeAttribute", ElementType.Class);
#endif
 ...
 (Class)GetCompilerRuntimeTypeNodeFor(CciNs, "TemplateInstanceAttribute", ElementType.Class);
      UnmanagedStructTemplateParameterAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(CciNs, "UnmanagedStructTemplateParameterAttribute", ElementType.Class);
      PointerFreeStructTemplateParameterAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(CciNs, "PointerFreeStructTemplateParameterAttribute", ElementType.Class);
      TemplateParameterFlagsAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(CciNs, "TemplateParameterFlagsAttribute", ElementType.Class);
#if !WHIDBEYwithGenerics
      GenericArrayToIEnumerableAdapter =
 (Class)GetCompilerRuntimeTypeNodeFor("StructuralTypes", "ArrayToIEnumerableAdapter", 1, ElementType.Class);
#endif
      GenericBoxed = (Struct)GetCompilerRuntimeTypeNodeFor("StructuralTypes", "Boxed", 1, ElementType.ValueType);
      GenericIEnumerableToGenericIListAdapter =
 (Class)GetCompilerRuntimeTypeNodeFor("StructuralTypes", "GenericIEnumerableToGenericIListAdapter", 1, ElementType.Class);
      GenericInvariant =
 (Struct)GetCompilerRuntimeTypeNodeFor("StructuralTypes", "Invariant", 1, ElementType.ValueType);
      GenericNonEmptyIEnumerable =
 (Struct)GetCompilerRuntimeTypeNodeFor("StructuralTypes", "NonEmptyIEnumerable", 1, ElementType.ValueType);
      GenericNonNull = (Struct)GetCompilerRuntimeTypeNodeFor("StructuralTypes", "NonNull", 1, ElementType.ValueType);
      GenericStreamUtility =
 (Class)GetCompilerRuntimeTypeNodeFor("StructuralTypes", "StreamUtility", 1, ElementType.Class);
      ...
      StreamNotSingletonException =
 (Class)GetCompilerRuntimeTypeNodeFor("System.Query", "StreamNotSingletonException", ElementType.Class);
      ...
      IllegalUpcastException =
 (Class)GetCompilerRuntimeTypeNodeFor(ContractsNs, "IllegalUpcastException", ElementType.Class);
 ...
 (DelegateNode) GetCompilerRuntimeTypeNodeFor(GuardsNs, "InitGuardSetsDelegate", ElementType.Class);
      CheckInvariantDelegate =
 (DelegateNode) GetCompilerRuntimeTypeNodeFor(GuardsNs, "CheckInvariantDelegate", ElementType.Class);
 ...
 (Class)GetCompilerRuntimeTypeNodeFor("Microsoft.Contracts", "ObjectInvariantException", ElementType.Class);
      ThreadConditionDelegate =
 (DelegateNode) GetCompilerRuntimeTypeNodeFor(GuardsNs, "ThreadConditionDelegate", ElementType.Class);
 ...
 (Class)GetCompilerRuntimeTypeNodeFor(ContractsNs, "UnreachableException", ElementType.Class);
 ...
 (Class)GetCompilerRuntimeTypeNodeFor(ContractsNs, "InvalidContractException", ElementType.Class);
      ...
      ContractMarkerException =
 (Class)GetCompilerRuntimeTypeNodeFor(ContractsNs, "ContractMarkerException", ElementType.Class);
      PreAllocatedExceptions =
 (Class)GetCompilerRuntimeTypeNodeFor(ContractsNs, "PreAllocatedExceptions", ElementType.Class);
      #endregion
      #region Attributes
      ...
      ConfinedAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(CompilerGuardsNs, "ConfinedAttribute", ElementType.Class);

      #region modelfield attributes and exceptions
      ModelfieldContractAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(ContractsNs, "ModelfieldContractAttribute", ElementType.Class);
      ...
      ModelfieldException =
 (Class)GetCompilerRuntimeTypeNodeFor("Microsoft.Contracts", "ModelfieldException", ElementType.Class);
      #endregion
      ...
      /* Diego's Attributes for Purity and WriteEffects */
        ...
        WriteConfinedAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(CompilerGuardsNs, "WriteConfinedAttribute", ElementType.Class);
        ...
        GlobalReadAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(CompilerGuardsNs, "GlobalReadAttribute", ElementType.Class);
        GlobalWriteAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(CompilerGuardsNs, "GlobalWriteAttribute", ElementType.Class);
        GlobalAccessAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(CompilerGuardsNs, "GlobalAccessAttribute", ElementType.Class);
        FreshAttribute = (Class)GetCompilerRuntimeTypeNodeFor(CompilerGuardsNs, "FreshAttribute", ElementType.Class);
        EscapesAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(CompilerGuardsNs, "EscapesAttribute", ElementType.Class);
        /*  */

      StateIndependentAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(ContractsNs, "StateIndependentAttribute", ElementType.Class);
      SpecPublicAttribute = (Class)GetCompilerRuntimeTypeNodeFor(ContractsNs, "SpecPublicAttribute", ElementType.Class);
      SpecProtectedAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(ContractsNs, "SpecProtectedAttribute", ElementType.Class);
      SpecInternalAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(ContractsNs, "SpecInternalAttribute", ElementType.Class);
      ...
      CapturedAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(CompilerGuardsNs, "CapturedAttribute", ElementType.Class);
      LockProtectedAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(CompilerGuardsNs, "LockProtectedAttribute", ElementType.Class);
      RequiresLockProtectedAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(CompilerGuardsNs, "RequiresLockProtectedAttribute", ElementType.Class);
      ImmutableAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(CompilerGuardsNs, "ImmutableAttribute", ElementType.Class);
      RequiresImmutableAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(CompilerGuardsNs, "RequiresImmutableAttribute", ElementType.Class);
      RequiresCanWriteAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(CompilerGuardsNs, "RequiresCanWriteAttribute", ElementType.Class);
      ...
      InferredReturnValueAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(ContractsNs, "InferredReturnValueAttribute", ElementType.Class);
      ...
      NoDefaultContractAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(CompilerGuardsNs, "NoDefaultContractAttribute", ElementType.Class);
      ReaderAttribute = (Class)GetCompilerRuntimeTypeNodeFor(CompilerGuardsNs, "ReaderAttribute", ElementType.Class);

      ShadowsAssemblyAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(ContractsNs, "ShadowsAssemblyAttribute", ElementType.Class);
      ...
      ElementsRepAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(ContractsNs, "ElementsRepAttribute", ElementType.Class);
      ElementsPeerAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(ContractsNs, "ElementsPeerAttribute", ElementType.Class);
      ElementAttribute = (Class)GetCompilerRuntimeTypeNodeFor(ContractsNs, "ElementAttribute", ElementType.Class);
      ElementCollectionAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(ContractsNs, "ElementCollectionAttribute", ElementType.Class);
      RecursionTerminationAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(ContractsNs, "RecursionTerminationAttribute", ElementType.Class);
      NoReferenceComparisonAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(ContractsNs, "NoReferenceComparisonAttribute", ElementType.Class);
      ResultNotNewlyAllocatedAttribute =
 (Class)GetCompilerRuntimeTypeNodeFor(ContractsNs, "ResultNotNewlyAllocatedAttribute", ElementType.Class);
#endregion
      #endregion
#endif
            Initialized = true;
      ...
      noHeapAllocationAttribute = null;
        ...
        {
            var aName = typeof(Uri).Assembly.GetName();
            var SystemId = Identifier.For(aName.Name);
            var aref = (AssemblyReference)TargetPlatform.AssemblyReferenceFor[SystemId.UniqueIdKey];
            if (aref == null)
            {
            ...
            if (string.IsNullOrEmpty(SystemDllAssemblyLocation.Location))
            {
                if (aref.Location == null)
                    SystemDllAssemblyLocation.Location =
                        Path.Combine(Path.GetDirectoryName(SystemAssemblyLocation.Location), "System.dll");
                else
    ...
    private static AssemblyNode/*!*/ GetSystemDataAssembly(bool doNotLockFile, bool getDebugInfo) {
      ...
      if (string.IsNullOrEmpty(SystemDataAssemblyLocation.Location)) {
        if (aref.Location == null)
          SystemDataAssemblyLocation.Location =
 Path.Combine(Path.GetDirectoryName(SystemAssemblyLocation.Location), "System.Data.dll");
        else
    ...
    private static AssemblyNode/*!*/ GetSystemXmlAssembly(bool doNotLockFile, bool getDebugInfo) {
      ...
      if (string.IsNullOrEmpty(SystemXmlAssemblyLocation.Location)) {
        if (aref.Location == null)
          SystemXmlAssemblyLocation.Location =
 Path.Combine(Path.GetDirectoryName(SystemAssemblyLocation.Location), "System.Xml.dll");
        else
...
#endif
        private static TypeNode /*!*/ GetGenericRuntimeTypeNodeFor(string /*!*/ nspace, string /*!*/ name,
            int numParams, ElementType typeCode)
        {
      ...
      if (TargetPlatform.TargetVersion != null && TargetPlatform.TargetVersion.Major == 1 && TargetPlatform.TargetVersion.Minor < 2)
        ...
        private static AssemblyNode /*!*/ GetCollectionsAssembly(bool doNotLockFile, bool getDebugInfo)
        {
            ...
            var AssemblyId = Identifier.For("System.Collections");
            var aref = (AssemblyReference)TargetPlatform.AssemblyReferenceFor[AssemblyId.UniqueIdKey];
            if (aref == null)
            {
                aref = new AssemblyReference();
            ...
            {
                if (aref.Location == null)
                    SystemRuntimeCollectionsAssemblyLocation.Location = Path.Combine(
                        Path.GetDirectoryName(SystemAssemblyLocation.Location), "System.Collections.dll");
                else
        ...
        private static TypeNode /*!*/ GetCollectionsGenericRuntimeTypeNodeFor(string /*!*/ nspace, string /*!*/ name,
            int numParams, ElementType typeCode)
        {
            if (TargetPlatform.GenericTypeNamesMangleChar != 0)
                name = name + TargetPlatform.GenericTypeNamesMangleChar + numParams;
      ...
      if (TargetPlatform.TargetVersion != null && TargetPlatform.TargetVersion.Major == 1 && TargetPlatform.TargetVersion.Minor < 2)
        ...
        private static TypeNode /*!*/
            GetCollectionsTypeNodeFor(string /*!*/ nspace, string /*!*/ name, ElementType typeCode)
        {
            TypeNode result = null;
        ...
        {
            if (SystemAssembly.Name == "mscorlib") return SystemAssembly;
            var AssemblyId = Identifier.For("System.Diagnostics.Debug");
            var aref = (AssemblyReference)TargetPlatform.AssemblyReferenceFor[AssemblyId.UniqueIdKey];
            if (aref == null)
            {
                aref = new AssemblyReference();
            ...
            {
                if (aref.Location == null)
                    SystemDiagnosticsDebugAssemblyLocation.Location = Path.Combine(
                        Path.GetDirectoryName(SystemAssemblyLocation.Location), "System.Diagnostics.Debug.dll");
                else
        ...
        private static TypeNode /*!*/
            GetDiagnosticsDebugTypeNodeFor(string /*!*/ nspace, string /*!*/ name, ElementType typeCode)
        {
            TypeNode result = null;
            ...
            if (result == null)
                result = CoreSystemTypes.GetDummyTypeNode(DiagnosticsDebugAssembly, nspace, name, typeCode);
            result.typeCode = typeCode;
            return result;
        }
        ...
        {
            if (SystemAssembly.Name == "mscorlib") return SystemAssembly;
            var AssemblyId = Identifier.For("System.Diagnostics.Tools");
            var aref = (AssemblyReference)TargetPlatform.AssemblyReferenceFor[AssemblyId.UniqueIdKey];
            if (aref == null)
            {
                aref = new AssemblyReference();
            ...
            {
                if (aref.Location == null)
                    SystemDiagnosticsToolsAssemblyLocation.Location = Path.Combine(
                        Path.GetDirectoryName(SystemAssemblyLocation.Location), "System.Diagnostics.Tools.dll");
                else
        ...
        private static TypeNode /*!*/
            GetDiagnosticsToolsTypeNodeFor(string /*!*/ nspace, string /*!*/ name, ElementType typeCode)
        {
            TypeNode result = null;
            ...
            if (result == null)
                result = CoreSystemTypes.GetDummyTypeNode(DiagnosticsToolsAssembly, nspace, name, typeCode);
            result.typeCode = typeCode;
            return result;
        }
        ...
        {
            if (SystemAssembly.Name == "mscorlib") return SystemAssembly;
            var AssemblyId = Identifier.For("System.Runtime.InteropServices");
            var aref = (AssemblyReference)TargetPlatform.AssemblyReferenceFor[AssemblyId.UniqueIdKey];
            if (aref == null)
            {
                aref = new AssemblyReference();
            ...
            {
                if (aref.Location == null)
                    SystemRuntimeInteropServicesAssemblyLocation.Location = Path.Combine(
                        Path.GetDirectoryName(SystemAssemblyLocation.Location), "System.Runtime.InteropServices.dll");
                else
        ...
        private static TypeNode /*!*/
            GetInteropTypeNodeFor(string /*!*/ nspace, string /*!*/ name, ElementType typeCode)
        {
            TypeNode result = null;
            if (SystemAssembly == null)
                Debug.Assert(false);
        ...
        {
            if (SystemAssembly.Name == "mscorlib") return SystemAssembly;
            var AssemblyId = Identifier.For("System.IO");
            var aref = (AssemblyReference)TargetPlatform.AssemblyReferenceFor[AssemblyId.UniqueIdKey];
            if (aref == null)
            {
                aref = new AssemblyReference();
            ...
            {
                if (aref.Location == null)
                    SystemRuntimeIOServicesAssemblyLocation.Location =
                        Path.Combine(Path.GetDirectoryName(SystemAssemblyLocation.Location), "System.IO.dll");
                else
        ...
        {
            if (SystemAssembly.Name == "mscorlib") return SystemAssembly;
            var AssemblyId = Identifier.For("System.Reflection");
            var aref = (AssemblyReference)TargetPlatform.AssemblyReferenceFor[AssemblyId.UniqueIdKey];
            if (aref == null)
            {
                aref = new AssemblyReference();
            ...
            {
                if (aref.Location == null)
                    SystemReflectionAssemblyLocation.Location =
                        Path.Combine(Path.GetDirectoryName(SystemAssemblyLocation.Location), "System.Reflection.dll");
                else
        ...
        private static TypeNode /*!*/
            GetReflectionTypeNodeFor(string /*!*/ nspace, string /*!*/ name, ElementType typeCode)
        {
            TypeNode result = null;
        ...
        {
            if (SystemAssembly.Name == "mscorlib") return SystemAssembly;
            var AssemblyId = Identifier.For("System.Resources.ResourceManager");
            var aref = (AssemblyReference)TargetPlatform.AssemblyReferenceFor[AssemblyId.UniqueIdKey];
            if (aref == null)
            {
                aref = new AssemblyReference();
            ...
            {
                if (aref.Location == null)
                    SystemResourceManagerAssemblyLocation.Location = Path.Combine(
                        Path.GetDirectoryName(SystemAssemblyLocation.Location), "System.Resources.ResourceManager.dll");
                else
        ...
        private static TypeNode /*!*/
            GetResourceManagerTypeNodeFor(string /*!*/ nspace, string /*!*/ name, ElementType typeCode)
        {
            TypeNode result = null;
            if (ReflectionAssembly == null)
                Debug.Assert(false);
        ...
        {
            if (SystemAssembly.Name == "mscorlib") return SystemAssembly;
            var AssemblyId = Identifier.For("System.Globalization");
            var aref = (AssemblyReference)TargetPlatform.AssemblyReferenceFor[AssemblyId.UniqueIdKey];
            if (aref == null)
            {
                aref = new AssemblyReference();
            ...
            {
                if (aref.Location == null)
                    SystemGlobalizationAssemblyLocation.Location = Path.Combine(
                        Path.GetDirectoryName(SystemAssemblyLocation.Location), "System.Globalization.dll");
                else
        ...
        private static TypeNode /*!*/
            GetGlobalizationTypeNodeFor(string /*!*/ nspace, string /*!*/ name, ElementType typeCode)
        {
            TypeNode result = null;
            ...
            if (result == null)
                result = CoreSystemTypes.GetDummyTypeNode(GlobalizationAssembly, nspace, name, typeCode);
            result.typeCode = typeCode;
            return result;
        }
        ...
        {
            if (SystemAssembly.Name == "mscorlib") return SystemAssembly;
            var AssemblyId = Identifier.For("System.Runtime.Extensions");
            var aref = (AssemblyReference)TargetPlatform.AssemblyReferenceFor[AssemblyId.UniqueIdKey];
            if (aref == null)
            {
                aref = new AssemblyReference();
            ...
            {
                if (aref.Location == null)
                    SystemRuntimeExtensionsAssemblyLocation.Location = Path.Combine(
                        Path.GetDirectoryName(SystemAssemblyLocation.Location), "System.Runtime.Extensions.dll");
                else
        ...
        private static TypeNode /*!*/
            GetRuntimeExtensionsTypeNodeFor(string /*!*/ nspace, string /*!*/ name, ElementType typeCode)
        {
            TypeNode result = null;
            ...
            if (result == null)
                result = CoreSystemTypes.GetDummyTypeNode(SystemRuntimeExtensionsAssembly, nspace, name, typeCode);
            result.typeCode = typeCode;
            return result;
        }
        ...
        {
            if (SystemAssembly.Name == "mscorlib") return SystemAssembly;
            var AssemblyId = Identifier.For("System.Serialization.DataContract");
            var aref = (AssemblyReference)TargetPlatform.AssemblyReferenceFor[AssemblyId.UniqueIdKey];
            if (aref == null)
            {
                aref = new AssemblyReference();
            ...
            {
                if (aref.Location == null)
                    SystemRuntimeSerializationAssemblyLocation.Location = Path.Combine(
                        Path.GetDirectoryName(SystemAssemblyLocation.Location),
        ...
        private static TypeNode /*!*/
            GetRuntimeSerializationTypeNodeFor(string /*!*/ nspace, string /*!*/ name, ElementType typeCode)
        {
            TypeNode result = null;
            ...
            if (result == null)
                result = CoreSystemTypes.GetDummyTypeNode(SystemRuntimeSerializationAssembly, nspace, name, typeCode);
            result.typeCode = typeCode;
            return result;
        }
        ...
        {
            if (SystemAssembly.Name == "mscorlib") return SystemAssembly;
            var ThreadingId = Identifier.For("System.Threading");
            var aref = (AssemblyReference)TargetPlatform.AssemblyReferenceFor[ThreadingId.UniqueIdKey];
            if (aref == null)
            {
                aref = new AssemblyReference();
            ...
            {
                if (aref.Location == null)
                    SystemThreadingAssemblyLocation.Location =
                        Path.Combine(Path.GetDirectoryName(SystemAssemblyLocation.Location), "System.Threading.dll");
                else
        ...
        private static TypeNode /*!*/
            GetThreadingTypeNodeFor(string /*!*/ nspace, string /*!*/ name, ElementType typeCode)
        {
            TypeNode result = null;
        ...
        {
            if (SystemAssembly.Name == "mscorlib") return SystemAssembly;
            var AssemblyId = Identifier.For("System.Runtime.InteropServices.WindowsRuntime");
            var aref = (AssemblyReference)TargetPlatform.AssemblyReferenceFor[AssemblyId.UniqueIdKey];
            if (aref == null)
            {
                aref = new AssemblyReference();
            ...
            {
                if (aref.Location == null)
                    SystemRuntimeWindowsRuntimeInteropServicesAssemblyLocation.Location = Path.Combine(
                        Path.GetDirectoryName(SystemAssemblyLocation.Location),
            ...
            if (aref.assembly == null)
                aref.Location = SystemRuntimeWindowsRuntimeInteropServicesAssemblyLocation.Location;
            return aref.assembly = AssemblyNode.GetAssembly(aref, doNotLockFile, getDebugInfo, true);
        }

        private static TypeNode /*!*/
            GetWindowsRuntimeInteropTypeNodeFor(string /*!*/ nspace, string /*!*/ name, ElementType typeCode)
        {
            TypeNode result = null;
            if (SystemRuntimeWindowsRuntimeInteropAssembly == null)
                Debug.Assert(false);
            else
                result = SystemRuntimeWindowsRuntimeInteropAssembly.GetType(Identifier.For(nspace),
                    Identifier.For(name));
            if (result == null)
                result = CoreSystemTypes.GetDummyTypeNode(SystemRuntimeWindowsRuntimeInteropAssembly, nspace, name,
                    typeCode);
            result.typeCode = typeCode;
            return result;
        }
        ...
        {
            var AssemblyId = Identifier.For("System.Runtime.WindowsRuntime");
            var aref = (AssemblyReference)TargetPlatform.AssemblyReferenceFor[AssemblyId.UniqueIdKey];
            if (aref == null)
            {
                aref = new AssemblyReference();
            ...
            {
                if (aref.Location == null)
                    SystemRuntimeWindowsRuntimeAssemblyLocation.Location = Path.Combine(
                        Path.GetDirectoryName(SystemAssemblyLocation.Location), "System.Runtime.WindowsRuntime.dll");
                else
        ...
        private static TypeNode /*!*/ GetGenericWindowsRuntimeTypeNodeFor(string /*!*/ nspace, string /*!*/ name,
            int numParams, ElementType typeCode)
        {
            if (TargetPlatform.GenericTypeNamesMangleChar != 0)
                name = name + TargetPlatform.GenericTypeNamesMangleChar + numParams;
        ...
        private static TypeNode /*!*/
            GetWindowsRuntimeTypeNodeFor(string /*!*/ nspace, string /*!*/ name, ElementType typeCode)
        {
            TypeNode result = null;
            if (SystemRuntimeWindowsRuntimeAssembly == null)
                Debug.Assert(false);
            ...
            if (result == null)
                result = CoreSystemTypes.GetDummyTypeNode(SystemRuntimeWindowsRuntimeAssembly, nspace, name, typeCode);
            result.typeCode = typeCode;
            return result;
        }

        private static AssemblyNode /*!*/
            GetSystemRuntimeWindowsRuntimeUIXamlAssembly(bool doNotLockFile, bool getDebugInfo)
        {
            var AssemblyId = Identifier.For("System.Runtime.WindowsRuntime.UI.Xaml");
            var aref = (AssemblyReference)TargetPlatform.AssemblyReferenceFor[AssemblyId.UniqueIdKey];
            if (aref == null)
            {
                aref = new AssemblyReference();
            ...
            {
                if (aref.Location == null)
                    SystemRuntimeWindowsRuntimeUIXamlAssemblyLocation.Location = Path.Combine(
                        Path.GetDirectoryName(SystemAssemblyLocation.Location),
        ...
        private static TypeNode /*!*/ GetGenericWindowsRuntimeUIXamlTypeNodeFor(string /*!*/ nspace, string /*!*/ name,
            int numParams, ElementType typeCode)
        {
            if (TargetPlatform.GenericTypeNamesMangleChar != 0)
                name = name + TargetPlatform.GenericTypeNamesMangleChar + numParams;
        ...
        private static TypeNode /*!*/
            GetWindowsRuntimeUIXamlTypeNodeFor(string /*!*/ nspace, string /*!*/ name, ElementType typeCode)
        {
            TypeNode result = null;
            if (SystemRuntimeWindowsRuntimeUIXamlAssembly == null)
                Debug.Assert(false);
            else
                result = SystemRuntimeWindowsRuntimeUIXamlAssembly.GetType(Identifier.For(nspace),
                    Identifier.For(name));
            if (result == null)
                result = CoreSystemTypes.GetDummyTypeNode(SystemRuntimeWindowsRuntimeUIXamlAssembly, nspace, name,
                    typeCode);
            result.typeCode = typeCode;
            return result;
        }
